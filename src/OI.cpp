...
#include "Commands/ReturnGyro.h"
#include "Commands/TrashCanLevel.h"
#include "Commands/UseGyro.h"
...
OI::OI() {
	...
	joystickButton3 = new JoystickButton(coPilot, 3);
	joystickButton3->WhenPressed(new MoveForward());
	joystickButton2 = new JoystickButton(coPilot, 2);
	joystickButton2->WhenPressed(new ReturnGyro());
	gyroGO = new JoystickButton(coPilot, 1);
	gyroGO->WhenPressed(new UseGyro());
	xbox = new Joystick(0);
	
	secondLevel = new JoystickButton(xbox, 7);
	secondLevel->WhenPressed(new lSecondToteLevel());
	firstLevel = new JoystickButton(xbox, 9);
	firstLevel->WhenPressed(new lFirstToteLevel());
	trashcanLevelButton = new JoystickButton(xbox, 4);
	trashcanLevelButton->WhenPressed(new TrashCanLevel());
	joystickButton1 = new JoystickButton(xbox, 10);
	...
	thirdLevel = new JoystickButton(xbox, 3);
	...
	SmartDashboard::PutData("UseGyro", new UseGyro());

	SmartDashboard::PutData("ReturnGyro", new ReturnGyro());
