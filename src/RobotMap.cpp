...
DigitalInput* RobotMap::liftRAutonomousMode1 = NULL;
DigitalInput* RobotMap::liftRAutonomousMode2 = NULL;
DigitalInput* RobotMap::liftRAutonomousMode3 = NULL;
...
void RobotMap::init() {
	...
	liftRAutonomousMode1 = new DigitalInput(10);
	lw->AddSensor("LiftR", "AutonomousMode1", liftRAutonomousMode1);
	
	liftRAutonomousMode2 = new DigitalInput(11);
	lw->AddSensor("LiftR", "AutonomousMode2", liftRAutonomousMode2);
	
	liftRAutonomousMode3 = new DigitalInput(12);
	lw->AddSensor("LiftR", "AutonomousMode3", liftRAutonomousMode3);
