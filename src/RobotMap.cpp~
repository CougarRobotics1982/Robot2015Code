...
DoubleSolenoid* RobotMap::clamppiston = NULL;
...
void RobotMap::init() {
	...
	driveTrainRightFront = new Talon(7);
	...
	clamppiston = new DoubleSolenoid(0, 0, 1);      
	lw->AddActuator("Clamp", "piston", clamppiston);
	
	clampCompressor1 = new Compressor(0);
	
	
	liftRlifter = new Talon(2);
	lw->AddActuator("LiftR", "lifter", (Talon*) liftRlifter);
